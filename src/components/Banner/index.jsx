        ...
        <section style={{backgroundImage: `url('https://img.freepik.com/fotos-premium/acordo-de-equipa-jovem-organizacao-acordo-de-forca_198067-195188.jpg?w=740')`}} className="bg-cover bg-center bg-no-repeat bg-fixed  h-screen relative overflow-hidden">
            ...
            <div className="relative z-10 sm:px-6 lg:px-8 py-10 lg:py-16 h-full">
                <div className="mt-[15%] max-w-2xl text-center mx-auto">
                    <p className="inline-block text-base font-medium bg-clip-text bg-gradient-to-l from-red-600 to-yellow-400 text-transparent">
                    ...
                    <p className="mt-5 text-gray-200 ">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi impedit, veritatis delectus deleniti ducimus tempora voluptatem eveniet obcaecati dolorem a facere sequi id. Omnis asperiores harum iure sapiente rem voluptas?</p>
                    <Link to="/" className="mt-8 mx-auto py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-yellow-600 text-white hover:bg-transparent border-yellow-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                        Saiba mais
